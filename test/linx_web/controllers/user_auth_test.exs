defmodule LinxWeb.UserAuthTest do
  use LinxWeb.ConnCase, async: true

  alias Linx.Accounts
  alias LinxWeb.UserAuth
  import Linx.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, LinxWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      LinxWeb.Endpoint.subscribe(live_socket_id)

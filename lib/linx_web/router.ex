defmodule LinxWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {LinxWeb.LayoutView, :root}
  ...
  pipeline :api_authenticated do
    plug LinxWeb.AuthAccessPipeline
  end

  pipeline :graphql do
    plug LinxWeb.Context
  end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: LinxWeb.Telemetry
    end
  end
  ...
  if Mix.env == :dev do
    forward "/graphiql", Absinthe.Plug.GraphiQL, schema: LinxWeb.Schema
  end
end
